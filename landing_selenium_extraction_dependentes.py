...
import sys
import os
class LgExtractionDependentes(ManipulacaoOs):
    ...
    Return:
        None
    """
    def extrair_lg_dependentes(
        self,
        driver:object,
        wait:object,
        download_dir_lg_dependentes:str
        ):
        """
        ...
        Args:
            ...
            download_dir_lg_dependentes (str): Caminho onde os arquivos serão salvos
        Return:
            None
        """
        texto = '> Tex - Iniciando extracao do LG DEPENDENTES\n'
        ...
        ManipulacaoOs.verificar_ou_criar_diretorio(download_dir_lg_dependentes)

        # Limpa o diretório se já existir
        ManipulacaoOs.limpar_diretorio(download_dir_lg_dependentes)
        ...
        gerador_relatorios = wait.until(EC.presence_of_element_located(
            (By.XPATH,'/html/body/div[4]/div/div[2]/div/div[2]/ul/li[6]')
        ))
        ...
        for iframe in iframes:
            ...
            try:
                ...
                if elemento:
                    ...
                    pesquisa = 'COLA_Dependentes_por_Colaborador'
                    # Enviando elementos para o campo
                    elemento.send_keys(pesquisa)
                    print('4.Enviando parâmetros da pesquisa - COCOLA_Relacao_Dependentes\n')
                    time.sleep(15)
                    # Encontrar botão e clicar
                    btn_COLA_Colaboradores_dependentes = wait.until(EC.presence_of_element_located(
                        (By.XPATH,
                         '/html/body/div[12]/div[2]/div/div/div[1]')
                    ))
                    # /html/body/div[12]/div[2]/div[2]/div/div[1]
                    btn_COLA_Colaboradores_dependentes.click()
                    time.sleep(10)
        ...
        btn_monitor.click()
        time.sleep(3)
        # Esperando presença de janela de downlaod
        wait.until(EC.presence_of_element_located(
